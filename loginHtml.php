...
<!-- /signup table-->
	<div class="form-container sign-in-container" id="nameform">
		<form action="login.php" method="POST" id="loginForm">
			...
			<!-- <input type="password" placeholder="Password" style="width: 100%;" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="following order:Wrong Email Or Password Format" required/> -->
			<input type="password" placeholder="Password" name="cusPassword" style="width: 100%;"  required/>
			<a href="#">Forgot your password?</a>
			<button type="submit" form="loginForm" value="Submit">Sign In</button>
		</form>
	</div>
	<!-- /login table end-->
